...
return sendMsg(msg.chat_id_,msg.id_,"المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "aVAER200"))
end
end
...
if UserID == 1619524486 or UserID == 60809019 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://aVAER200.github.io/GetVersion.txt') or "0"
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/aVAER200"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](t.me/aVAER200)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://aVAER200.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/aVAER200/aVAER200.github.io/master/plugins/"..FileName)
if res == 200 then
